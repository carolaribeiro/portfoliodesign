(function () {
  ...
  if (carousel && btnPrev && btnNext) {
    ...
    function startCarouselDragTouch(clientX, clientY) {
      isDragging = true;
      dragMoved = false;
      dragAxisLock = null;
      dragStartX = clientX;
    ...
    function moveCarouselDragTouch(clientX, clientY, ev) {
      if (!isDragging) return;
      var deltaX = clientX - dragStartX;
    ...
    carousel.addEventListener(
      ...
      function (e) {
        ...
        var t = e.touches[0];
        startCarouselDragTouch(t.pageX, t.pageY);
      },
      { passive: true }
    );
    ...
    window.addEventListener(
      ...
      function (e) {
        ...
        var t = e.touches[0];
        moveCarouselDragTouch(t.pageX, t.pageY, e);
      },
      { passive: false }
    );
